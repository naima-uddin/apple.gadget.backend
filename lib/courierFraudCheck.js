 ...
 * (Pathao, Steadfast, RedX). Not limited to AppleBD orders.
...
export async function fetchLifetimeCourierStats(
  ...
  const result = {
    ...
    description:
      "Lifetime parcel history for this mobile on Pathao, Steadfast, and RedX networks (all shops, not only AppleBD).",
    configured,
    anyConfigured,
    couriers,
