...
const LEGACY_MAP = {
  catalog: [
    ...
    'products.waitlist', 'products.questions', 'products.preorders', 'products.delivery',
    'products.packaging', 'products.dropshipping',
  ],
  orders: [
...
// Passes if the admin has ANY of the given permission keys. Used where one
// route is reachable from more than one section — e.g. Discounts lives under
// "Storefront Design" (content) but is also a products/catalog concern, so it
// accepts either.
